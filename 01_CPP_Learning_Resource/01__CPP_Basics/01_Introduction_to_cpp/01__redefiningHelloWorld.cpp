...
//I don't think aboue code had gave you any surprise if you are already familiar with C++
...
//now to reduce the ambiguity we already declared that we are taking some things from std
//and for that we used namespace which reduce the conflicts.
